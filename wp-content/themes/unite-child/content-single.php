...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<!-- Add Country, Genre, Ticket Price and Release Date -->
	
	<?php echo get_the_term_list( $post->ID, "country", 'Countries: ', ', ', '' ); ?><br> 
	<?php echo get_the_term_list( $post->ID, "genre", 'Genre: ', ', ', '' ); ?> <br>
	Ticket Price: <?php echo get_post_meta($post->ID, "ticket_price", true); ?><br>
	Release Date: <?php echo  date("F j, Y", strtotime(get_post_meta($post->ID, "release_date", true))); ?><br>
	<br><br>
